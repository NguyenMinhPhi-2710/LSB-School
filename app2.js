...
var cardbodys= document.querySelectorAll("#accordion .cardbody");

    console.log(cardbodys);
    [...acc].forEach( (item,index) => item.addEventListener("click",function(e){
    [...cardbodys].forEach( (item) => item.style.display= `none`)
    cardbodys[index].style.display= `block`;

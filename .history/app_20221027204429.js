...
window.addEventListener("scroll",function(){
    ...
    // menu hover effect
    var headerNavItem1s= [...document.querySelectorAll(".header-nav_items")];
    headerNavItem1s.forEach( (item) => item.classList.toggle("header-nav_link",window.scrollY=0));
    // var headerNavItem2s= [...document.querySelectorAll(".header-nav_items a")];
    // headerNavItem2s.forEach( (item) => item.classList.toggle("hoverEffect",window.scrollY>0));
})

...
window.addEventListener("scroll",function(){
    ...
    var headerNavItems= [...document.querySelectorAll(".header-nav_items a")];
    console.log(headerNavItems);
    // headerNavItems.forEach( (item) => item.classList.toggle("hoverEffect",window.scrollY >0));
...
window.addEventListener("load", function(){
    ...
    function handleHoverLink1(event){
        ...
        line.style.top= `${top + offsetTop*2}px`;
    }
